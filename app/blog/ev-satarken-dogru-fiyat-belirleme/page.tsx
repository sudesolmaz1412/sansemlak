...
export const metadata = {
  title: "Ev Satarken Doğru Fiyat Nasıl Belirlenir? | Şans Yapı Gayrimenkul & Emlak",
  description:
    "Ev satarken doğru fiyat nasıl belirlenir? Gayrimenkulünüzün değerini doğru belirlemek ve satış sürecini hızlandırmak için dikkat edilmesi gerekenleri öğrenin.",
};
