...
export const metadata = {
  title: "Esenyurt Satılık Daire Fiyatları Nasıl Değerlendirilir? | Şans Yapı Gayrimenkul & Emlak",
  description:
    "Esenyurt satılık daire fiyatlarını değerlendirirken konum, metrekare, bina yaşı, ulaşım imkanları ve yatırım potansiyeli gibi önemli kriterleri öğrenin.",
};
